...
public class MultiverseVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<" + prefix + "autoheal>"))
			newString = newString.replaceAll("<" + prefix + "autoheal>", String.valueOf(mw.getAutoHeal()));
		if (newString.contains("<" + prefix + "hunger>"))
			newString = newString.replaceAll("<" + prefix + "hunger>", String.valueOf(mw.getHunger()));
		if (newString.contains("<" + prefix + "price>"))
			newString = newString.replaceAll("<" + prefix + "price>", String.valueOf(mw.getPrice()));
		return newString;
	}
}
