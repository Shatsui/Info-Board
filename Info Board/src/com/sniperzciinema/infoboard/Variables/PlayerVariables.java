...
import com.sniperzciinema.infoboard.Util.VaraibleUtils.Direction;
import com.sniperzciinema.infoboard.Util.VaraibleUtils.Ping;
...
public class PlayerVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<worlddifficulty>"))
			newString = newString.replaceAll("<worlddifficulty>", String.valueOf(player.getWorld().getDifficulty()));
		...
		if (newString.contains("<worldplayers>"))
			newString = newString.replaceAll("<worldplayers>", String.valueOf(player.getWorld().getPlayers().size()));
		...
		if (newString.contains("<lifetime>"))
			newString = newString.replaceAll("<lifetime>", String.valueOf(player.getTicksLived() / 20));
		...
		if (newString.contains("<helmetdurability>"))
			newString = newString.replaceAll("<helmetdurability>", String.valueOf(player.getInventory().getHelmet() == null ? 0 : player.getInventory().getHelmet().getDurability()));
		...
		if (newString.contains("<chestplatedurability>"))
			newString = newString.replaceAll("<chestplatedurability>", String.valueOf(player.getInventory().getChestplate() == null ? 0 : player.getInventory().getHelmet().getDurability()));
		...
		if (newString.contains("<leggingsdurability>"))
			newString = newString.replaceAll("<leggingsdurability>", String.valueOf(player.getInventory().getLeggings() == null ? 0 : player.getInventory().getHelmet().getDurability()));
		...
		if (newString.contains("<bootsdurability>"))
			newString = newString.replaceAll("<bootsdurability>", String.valueOf(player.getInventory().getBoots() == null ? 0 : player.getInventory().getHelmet().getDurability()));
		...
		if (newString.contains("<doesanyonehave"))
		{
			...
			newString = newString.replaceAll("<doesanyonehave" + (perm) + ">", String.valueOf(someone));
		}
		if (newString.contains("<howmanyhave"))
		{
			...
			newString = newString.replaceAll("<howmanyhave" + (perm) + ">", String.valueOf(someone));
		}
		return newString;
	}
