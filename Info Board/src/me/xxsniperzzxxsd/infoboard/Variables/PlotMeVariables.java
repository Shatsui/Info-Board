	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<plotmeinid>"))
			if(PlotManager.getPlotById(player.getLocation()) != null)
				newString = newString.replaceAll("<plotmeinid>", String.valueOf(PlotManager.getPlotById(player.getLocation()).id));
			else
		...
		if (newString.contains("<plotmeincomments>"))
			if(PlotManager.getPlotById(player.getLocation()) != null)
				newString = newString.replaceAll("<plotmeincomments>", String.valueOf(PlotManager.getPlotById(player.getLocation()).getCommentsCount()));
			else
				newString = newString.replaceAll("<plotmeincomments>", "0");
		
		if (newString.contains("<plotmeinbid>"))
			if(PlotManager.getPlotById(player.getLocation()) != null)
				newString = newString.replaceAll("<plotmeinbid>", String.valueOf(PlotManager.getPlotById(player.getLocation()).currentbid));
			else
		...
		if (newString.contains("<plotmeinfinished>"))
			if(PlotManager.getPlotById(player.getLocation()) != null)
				newString = newString.replaceAll("<plotmeinfinished>", String.valueOf(PlotManager.getPlotById(player.getLocation()).finished));
			else
				newString = newString.replaceAll("<plotmeinfinished>", "false");
		
		if (newString.contains("<plotmeinforsale>"))
			if(PlotManager.getPlotById(player.getLocation()) != null)
				newString = newString.replaceAll("<plotmeinforsale>", String.valueOf(PlotManager.getPlotById(player.getLocation()).forsale));
			else
		...
		if (newString.contains("<plotmebid") && !newString.contains("<plotmebidder")){
