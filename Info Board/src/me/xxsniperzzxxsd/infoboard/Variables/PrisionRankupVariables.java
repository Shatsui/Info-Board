...
//import net.craftservers.prisonrankup.Rankup;
...
public class PrisionRankupVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<" + prefix + "rank>"))
			newString = newString.replaceAll("<" + prefix + "rank>", PrisonRankup);
		if (newString.contains("<" + prefix + "arenaowner>"))
			newString = newString.replaceAll("<" + prefix + "arenaowner>", a == null ? "Unknown" : a.getOwner());
		if (newString.contains("<" + prefix + "arenaprefix>"))
			newString = newString.replaceAll("<" + prefix + "arenaprefix>", a == null ? "Unknown" : a.getPrefix());
		...
		if (newString.contains("<" + prefix + "statsdeaths>"))
			newString = newString.replaceAll("<" + prefix + "statsdeath>", String.valueOf(stats.getStat(type.DEATHS)));
		if (newString.contains("<" + prefix + "statsdamage>"))
			newString = newString.replaceAll("<" + prefix + "statsdamage>", String.valueOf(stats.getStat(type.DAMAGE)));
		if (newString.contains("<" + prefix + "statsdamagetake>"))
			newString = newString.replaceAll("<" + prefix + "statsdamagetake>", String.valueOf(stats.getStat(type.DAMAGETAKE)));
		if (newString.contains("<" + prefix + "statslosses>"))
			newString = newString.replaceAll("<" + prefix + "statslosses>", String.valueOf(stats.getStat(type.LOSSES)));
		if (newString.contains("<" + prefix + "statswins>"))
			newString = newString.replaceAll("<" + prefix + "statswins>", String.valueOf(stats.getStat(type.WINS)));
