...
public class SkillzVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<skillzarchery>"))
			newString = newString.replaceAll("<skillzarchery>", String.valueOf(api.getLevel(player, "Archery")));
		if (newString.contains("<skillzaxescombat>"))
			newString = newString.replaceAll("<skillzaxescombat>", String.valueOf(api.getLevel(player, "Axes Combat")));
		if (newString.contains("<skillzdigging>"))
			newString = newString.replaceAll("<skillzdigging>", String.valueOf(api.getLevel(player, "Digging")));
		if (newString.contains("<skillzfarming>"))
			newString = newString.replaceAll("<skillzfarming>", String.valueOf(api.getLevel(player, "Farming")));
		if (newString.contains("<skillzmining>"))
			newString = newString.replaceAll("<skillzmining>", String.valueOf(api.getLevel(player, "Mining")));
		if (newString.contains("<skillzswimming>"))
			newString = newString.replaceAll("<skillzswimming>", String.valueOf(api.getLevel(player, "Swimming")));
		if (newString.contains("<skillzswordscombat>"))
			newString = newString.replaceAll("<skillzswordscombat>", String.valueOf(api.getLevel(player, "Swords Combat")));
