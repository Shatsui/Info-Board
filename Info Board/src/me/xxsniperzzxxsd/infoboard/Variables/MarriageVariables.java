...
public class MarriageVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<" + prefix + "partner>"))
			newString = newString.replaceAll("<" + prefix + "partner>", mp.getPartner() != null ? mp.getPartner() : "Unknown");
		if (newString.contains("<" + prefix + "online>"))
			newString = newString.replaceAll("<" + prefix + "online>", String.valueOf(Bukkit.getPlayer(mp.getPartner() != null ? "true" : "false")));
		if (newString.contains("<" + prefix + "married>"))
			newString = newString.replaceAll("<" + prefix + "married>", String.valueOf(mp.isMarried()));
